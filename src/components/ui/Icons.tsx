...
// Lucide-style icons at 24x24 with 2px stroke
// All accept className for sizing via Tailwind

type IconProps = SVGProps<SVGSVGElement> & { size?: number };

function icon(size: number, d: string, extra?: string) {
  const p = size / 24;
  return (
...
export function AlbumIcon({ size = 24, ...props }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none"
      stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" {...props}>
...
export function AlertTriangleIcon({ size = 24, ...props }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none"
      stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" {...props}>
      <path d="M12 9v4M12 17h.01M18 21V5a2 2 0 0 0-2-2H8a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2z" />
    </svg>
  );
}
